...
const SubscriptionCard = ({ name, price, icon, billing, currency, color, category, plan, expanded, renewalDate, onPress, paymentMethod, startDate, status }: SubscriptionCardProps) => {
    return (
